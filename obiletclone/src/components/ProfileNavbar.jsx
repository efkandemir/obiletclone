      ...
      <div>
        ...
        <div className="ml-[375px] mt-8 w-[150px] h-[550px] border border-gray-700">
          <button
            ...
            className={`ml-4 mt-4 text-sm font-semibold hover:text-red-600 ${currentPath === "/uye/biletler" ? "text-red-600" : "text-black"
              }`}
          >
            Seyahatlerim
          </button>
          ...
          <button
            ...
            className={`ml-4 mt-4 text-sm font-semibold hover:text-red-600 ${currentPath === "/uye/bilgi" ? "text-red-600" : "text-black"
              }`}
          >
