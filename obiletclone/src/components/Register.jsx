                    ...
                    <form className="px-6">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            <label className="flex items-center text-xs">
                                <input type="checkbox" className="mr-2 flex" /> Kişisel verilerin işlenmesine ilişkin <span className="	text-decoration-line: underline">Aydınlatma Metni</span>’ni okudum.
                            </label>
                        </div>
